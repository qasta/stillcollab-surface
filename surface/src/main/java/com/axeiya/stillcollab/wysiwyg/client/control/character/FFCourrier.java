...
public class FFCourrier extends AbstractControl implements ClickHandler, IsWidget {
  private Button ui;
  private FontFamilyInserter inserter;
  
  private static final FontFamilyConfig config = new FontFamilyConfig("Courrier");

  public FFCourrier() {
    ui = new Button("Courrier");
